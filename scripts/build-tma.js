...
if (result.status === 0) {
  ...
  html = html.replace(
    '</style>',
    `#root { height: var(--tg-viewport-stable-height, 100dvh); max-height: var(--tg-viewport-stable-height, 100dvh); padding: calc(var(--mescott-tg-safe-top, 0px) + 28px) var(--mescott-tg-safe-right, 0px) calc(var(--mescott-tg-safe-bottom, 0px) + 6px) var(--mescott-tg-safe-left, 0px); box-sizing: border-box; }\n</style>`,
  )
